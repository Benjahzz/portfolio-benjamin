    ...
    return (
        <section className="wrapper-principal" id="home">
          <div className="container-principal">
            <div className="main-info animate__animated sanimate__fadeInLeft">
              <h1 className="main-info__title">
                Hi, I'm Benjamin. A <span>Frontend</span> and{" "}
                <span>Backend</span> developer.
              </h1>
              <p className="main-info__text">
                I love design modern a intuitive websites that attract people,
                im also a backend developer, i have experience in multiple
                languages
              </p>
